...
def process_config():
        ...
        # net_arg.add_argument('--rnn_cell_size', type=int, default=50)
        ...
        net_arg.add_argument('--target_model', type=str, default="ilcr_kld", 
                help='emnlp18, aaai18, ilcr_s, ilcr_sc, ilcr_attn, ilcr_stru, ilcr_doc_stru')

        train_arg = add_argument_group('Training')
        train_arg.add_argument('--op', type=str, default='adam')  # adam, sgd, asgd, rmsprop
        train_arg.add_argument('--eps', type=float, default=1e-5)
        ...
        train_arg.add_argument('--max_epoch', type=int, default=45)
        train_arg.add_argument('--loss_type', type=str, default="MSELoss")  # CrossEntropyLoss, MSELoss, nLLloss ...
        train_arg.add_argument('--eval_type', type=str, default="qwk")  # accuracy, qwk
        ...
        specific_arg.add_argument('--beta_ema', type=float, default=0.99, help='param used in temporal averaging')  # 0.99?
